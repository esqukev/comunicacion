...
function init() {
    ...
    btnEnviar.onclick = function() {
        ...
        //condicional que valida y permite enviar el correo de suscripcion
        if (email === '') {
            ...
            emailjs.sendForm('service_bitkfhz', 'template_fl3w4cn', '#form3', 'ebhAYh_kbONvNXSqU');
            cleanInputs();
        }
